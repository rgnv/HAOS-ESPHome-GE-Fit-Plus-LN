...
class GEScale : public Component, public ble_client::BLEClientNode {
 ...
 protected:
  ...
  uint8_t qn_stored_retry_count_{0};
  bool qn_stored_retry_pending_{false};
  ...
  void schedule_qn_stored_retry_();
  void send_qn_history_start_();
  void send_qn_stored_query_();
