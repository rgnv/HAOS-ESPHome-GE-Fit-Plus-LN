...
Connect, notification subscription, handshake writes, and cleanup each have bounded
timeouts so a stale BlueZ GATT operation returns to the discovery loop.
